            ...
            <Wrapper>
                <div className="flex flex-col max-w-[800px] mx-auto">
                    ...
                    <div className="flex w-full justify-start items-center mb-10 flex-wrap">
                        <Image
                            src={"/assets/magda_dimitrescu_03.jpg"}
                            width={900}
                            height={900}
                            alt="Magda Dimitrescu"
                            className="w-[45%] h-auto aspect-square object-cover mr-10 rounded-full"
                        />
                        <div className="flex flex-col items-start justify-start w-full md:w-[45%]">
                            <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title1}</h2>
                            <p className="w-full ">{pageDate.paragraph1}</p>
                        </div>
                    </div>

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title2}</h2>
                    <p className="w-full  mb-5">{pageDate.paragraph2}</p>

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title3}</h2>
                    <p className="w-full  mb-5">{pageDate.paragraph3}</p>

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title4}</h2>
                    <p className="w-full  mb-5">{pageDate.paragraph4}</p>

                    <Image
                        src={"/assets/magda_dimitrescu_02.jpg"}
                        width={1920}
                        height={1080}
                        alt="Magda Dimitrescu"
                        className="w-full h-auto mr-10 rounded-lg mb-10"
                    />

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title5}</h2>
                    <p className="w-full  mb-5">{pageDate.paragraph5}</p>

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title6}</h2>
                    <p className="w-full  mb-5">{pageDate.paragraph6}</p>

                    <h2 className="text-2xl md:text-3xl mb-5 text-purple">{pageDate.title7}</h2>
